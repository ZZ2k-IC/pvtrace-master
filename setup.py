...
if __version__ is None:
    __version__ = "2.1.6"  # fallback version
...
setup(
    ...
    install_requires=["numpy", "pandas", "anytree", "meshcat>=0.0.16", "trimesh[easy]", "matplotlib", "PySide2", "progressbar2"],
    classifiers=[
